...
Version: 1.10.28 - Day Editor UX Update | Plattformen: Android, iOS, Desktop
...
- `Dokumentation/CHANGELOG-v1.10.28.md` (Day-Editor Modal UX: Header-Refresh entfernt, Footer klappt bei POI-Scroll ein und bei Scroll-Ende wieder aus, moderne Animationen fuer mobile Bedienung)
