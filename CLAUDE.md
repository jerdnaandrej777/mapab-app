...
Version: 1.10.31 - Community Gallery + POI Social + Generation UX + Routing/Filter Stabilization | Plattformen: Android, iOS, Desktop
...
| `lib/data/repositories/supabase_poi_repo.dart` | Supabase PostGIS POI-Repository: search_pois_in_radius/bounds RPC, uploadEnrichedPOI/Batch, snake_caseâ†’camelCase Mapping (v1.9.13) |
...
| `lib/data/repositories/social_repo.dart` | Social Features Repository: loadFeaturedTrips, searchPublicTrips, likeTrip, loadUserProfile, publishTrip, importTrip - Supabase RPC Integration (v1.10.0) + Tabellenname-Fix public_tripsâ†’trips (v1.10.1) |
...
- `Dokumentation/CHANGELOG-v1.10.31.md` (Community-Tripgalerie + POI-Social Feed, dominantere Generierungs-Animationen, Start-/Filter-/Radius-Stabilisierung, neuer Release-Build mit aktualisierten QR-Links)
