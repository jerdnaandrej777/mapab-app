...
Technische Dokumentation zur App-Architektur.

| Dokument | Beschreibung |
|----------|--------------|
| [POI-SYSTEM](architecture/POI-SYSTEM.md) | POI-Datenfluss, Enrichment, Caching |
| [PROVIDER-GUIDE](architecture/PROVIDER-GUIDE.md) | Riverpod State Management |
...
| Dokument | Beschreibung |
|----------|--------------|
| [ENDPOINTS](api/ENDPOINTS.md) | Alle API-Endpoints |

---

## Referenz

Nachschlagewerke und Hilfestellung.
...
| [CHANGELOG v1.10.51](../Dokumentation/CHANGELOG-v1.10.51.md) | Release-Details Social-Import + Standort-Start |
